...
def process_all_files():
    ...
    all_data = {}
    for filepath in glob.glob("*Tail*.csv"):
...
if __name__ == "__main__":
    ...
    if all_data:
        ...
        print(get_value(all_data[first_file], 'H21', 'Sweep003', 'TailTau2'))
        print(get_values_across_sweeps(all_data[first_file], 'J21', 'TailTau2'))
