...
def test_manual_qc(df, cell_index):
    if 'Valid QC' in df['Unnamed: 1_level_0'].columns:
        value = df['Unnamed: 1_level_0']['Valid QC'][cell_index]
...
def main(input_file, output_file,final_output_file):
    # input_file = '-100mV_Plate1.CSV'
    # output_file = '-100_Plate1.csv'
    # final_output_file = '-100_Plate1_final.csv'
...
inlist = ['-75mV_Plate1.csv']
out_first=['-75_Plate1.csv']
outlist = ['-75_Plate1_final.csv']
